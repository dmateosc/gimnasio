...
//Subida de imagenes
router.post(['/image-muscle-id/:id','/image-muscle-name/:nombre'],multiMiddlewareMuscle.single('image'),GymController.uploadMusculoImage);
router.post(['/image-user/:id','/image-user/:nombre'],multiMiddlewareUser.single('image'),GymController.uploadUserImage);
router.post(['/image-exercise/:id','/image-exercise/:nombre'],multiMiddlewareExercise.single('image'),GymController.uploadEjercicioImage);
